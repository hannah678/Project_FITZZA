...
-- 파일명 중복 안됨
insert into board_common_image(board_num, file1, file2, file3, file4, file5) values(1, 'codi_book_img1.png', 'codi_book_img2(2).png', 'codi_book_img3(2).png', 'codi_book_img4(2).png', 'codi_book_img5(2).png');
insert into board_common_image(board_num, file1, file2, file3, file4, file5) values(2, 'codi_book_img2.png(1)', 'codi_book_img2(3).png', 'codi_book_img3(3).png', 'codi_book_img4(3).png', 'codi_book_img5(3).png');
insert into board_common_image(board_num, file1, file2, file3, file4, file5) values(3, 'codi_book_img3.png', 'codi_book_img2.png(4)', 'codi_book_img3(4).png', 'codi_book_img4(4).png', 'codi_book_img5(4).png');
insert into board_common_image(board_num, file1, file2, file3, file4, file5) values(4, 'codi_book_img4.png', 'codi_book_img2.png(5)', 'codi_book_img3(5).png', 'codi_book_img4(5).png', 'codi_book_img5(5).png');
insert into board_common_image(board_num, file1, file2, file3, file4, file5) values(5, 'codi_book_img5.png', 'codi_book_img2.png(6)', 'codi_book_img3(6).png', 'codi_book_img4(6).png', 'codi_book_img5(6).png');
insert into board_common_image(board_num, file1, file2, file3, file4, file5) values(6, 'codi_book_img6.png', 'codi_book_img2.png(7)', 'codi_book_img3(7).png', 'codi_book_img4(7).png', 'codi_book_img5(7).png');
insert into board_common_image(board_num, file1, file2, file3, file4, file5) values(7, 'codi_book_img7.png', 'codi_book_img2.png(8)', 'codi_book_img3(8).png', 'codi_book_img4(8).png', 'codi_book_img5(8).png');
insert into board_common_image(board_num, file1, file2, file3, file4, file5) values(8, 'codi_book_img8.png', 'codi_book_img2.png', 'codi_book_img3.png', 'codi_book_img4.png', 'codi_book_img5.png');
insert into board_common_image(board_num, file1, file2, file3, file4, file5) values(9, 'codi_book_img9.png', 'codi_book_img2.png', 'codi_book_img3.png', 'codi_book_img4.png', 'codi_book_img5.png');
insert into board_common_image(board_num, file1, file2, file3, file4, file5) values(10, 'codi_book_img10.png', 'codi_book_img2.png', 'codi_book_img3.png', 'codi_book_img4.png', 'codi_book_img5.png');
insert into board_common_image(board_num, file1, file2, file3, file4, file5) values(11, 'codi_book_img11.png', 'codi_book_img2.png', 'codi_book_img3.png', 'codi_book_img4.png', 'codi_book_img5.png');
insert into board_common_image(board_num, file1, file2, file3, file4, file5) values(12, 'codi_book_img12.png', 'codi_book_img2.png', 'codi_book_img3.png', 'codi_book_img4.png', 'codi_book_img5.png');
insert into board_common_image(board_num, file1, file2, file3, file4, file5) values(13, 'codi_book_img1(1).png', 'codi_book_img2.png', 'codi_book_img3.png', 'codi_book_img4.png', 'codi_book_img5.png');
insert into board_common_image(board_num, file1, file2, file3, file4, file5) values(14, 'codi_book_img2(1).png', 'codi_book_img2.png', 'codi_book_img3.png', 'codi_book_img4.png', 'codi_book_img5.png');
insert into board_common_image(board_num, file1, file2, file3, file4, file5) values(15, 'codi_book_img3(1).png', 'codi_book_img2.png', 'codi_book_img3.png', 'codi_book_img4.png', 'codi_book_img5.png');
insert into board_common_image(board_num, file1, file2, file3, file4, file5) values(16, 'codi_book_img4(1).png', 'codi_book_img2.png', 'codi_book_img3.png', 'codi_book_img4.png', 'codi_book_img5.png');
insert into board_common_image(board_num, file1, file2, file3, file4, file5) values(17, 'codi_book_img5(1).png', 'codi_book_img2.png', 'codi_book_img3.png', 'codi_book_img4.png', 'codi_book_img5.png');
insert into board_common_image(board_num, file1, file2, file3, file4, file5) values(18, 'codi_book_img6(1).png', 'codi_book_img2.png', 'codi_book_img3.png', 'codi_book_img4.png', 'codi_book_img5.png');
insert into board_common_image(board_num, file1, file2, file3, file4, file5) values(19, 'codi_book_img7(1).png', 'codi_book_img2.png', 'codi_book_img3.png', 'codi_book_img4.png', 'codi_book_img5.png');
insert into board_common_image(board_num, file1, file2, file3, file4, file5) values(20, 'codi_book_img8(1).png', 'codi_book_img2.png', 'codi_book_img3.png', 'codi_book_img4.png', 'codi_book_img5.png');
