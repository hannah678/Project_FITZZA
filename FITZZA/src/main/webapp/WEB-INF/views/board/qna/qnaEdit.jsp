...
<body>
    <div class="boardcontainer">
        ...
        <form method="post" action="" id="boardFrm">
            <ul>
                <li>제목 &emsp; <input type="text" name="subject" id="subject" placeholder='	질문 제목을 입력해주세요.' value="트러커 어디껀지 알고싶어요ㅜㅜ"/></li>
				<hr/>
				<li>내용 &emsp; <textarea name="introduce" id="introduce" rows="10" cols="90" placeholder='	질문 내용을 입력해주세요.'>이 트러커 정보 아시는분 계신가요~?</textarea></li>
				<hr/>
